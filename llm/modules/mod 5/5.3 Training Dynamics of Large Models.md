...
2. **Gradient clipping**: Prevents exploding gradients by limiting their magnitude
```python
torch.nn.utils.clip_grad_norm_(model.parameters(), max_norm=1.0)
```

2. **Layer normalization placement**: "Pre-LN" (applying normalization before attention and FFN blocks) improves stability
```python
