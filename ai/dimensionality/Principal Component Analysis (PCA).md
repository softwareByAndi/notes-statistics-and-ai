...
- **PC 1** = a straight line crossing through the dataset, from which the orthogonal distance to all points is minimized. see [[Residual Sum of Squares - RSS]]?
...
### see also:
```dataview
LIST FROM [[Principal Component Analysis (PCA)]] SORT file.name ASC
```
