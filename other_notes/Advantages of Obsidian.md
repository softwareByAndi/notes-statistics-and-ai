Obsidian will allow me to spend less time organizing notes, and more time typing because: 
1. links and tags can be added to notes to reference other notes &/or concepts 
2. backlinks are also visible for each note, showing a list of any other notes that reference it.
3. a mind map / graph showing note relations is auto generated using these links.
